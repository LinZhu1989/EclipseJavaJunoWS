...
public class MessageUI extends JFrame implements ActionListener {
	...
	public MessageUI(MessageType msgType) {
		...
		if (msgType.equals(MessageType.GUIDE)) {
			setLables(msgType);
	...
	private void setLables(MessageType t) {
		...
		if (t.equals(MessageType.ABOUT)) {
			...
			lblInfo = new MyLabel("Beta Version: Release (1.0.0)",
					SwingConstants.CENTER);
			...
			JLabel label = new JLabel(
					"<html>LinkedIn Helper Common Question & Answers<br>=======================================<br><br>Q: Which browser is supported by the helper?<br>"
							...
							+ "Please contact tracyjuly0706@gmail.com if you have more questions or there is any bug.Thank you.</html>");
			label.setPreferredSize(new Dimension(550, 1500));
			label.setFont(new java.awt.Font("Dialog", 1, 21));

			JScrollPane jScrollPane = new JScrollPane(label);
			this.setTitle("LinkedIn Helper Common Question & Answers");
